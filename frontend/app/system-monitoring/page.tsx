  ...
  return (
    ...
    <CardHeader className="border-b pb-2">
      ...
      <CardDescription className="text-sm text-muted-foreground">
        Choose a device by scanning your gateway or enter the IP directly.
      </CardDescription>
    </CardHeader>
    <CardContent>
      {/* Scan by Gateway */}
      <div className="mb-5">
        <h3 className="text-md font-medium mb-1">Scan by Gateway</h3>
        ...
        <div className="flex items-center mt-3">
          ...
          >
            ...
            <Button onClick={() => selectedDevice && onSelect(selectedDevice)} size="sm">
              Connect
            </Button>
        </div>
      </div>
      ...
      {/* Direct IP Entry */}
      <div>
        <h3 className="text-md font-medium mb-1">Direct IP Entry</h3>
        <div className="flex items-center gap-2">
          <input
            type="text"
            value={directIP}
